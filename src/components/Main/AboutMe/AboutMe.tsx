       ...
       <AnimatedPage>
          <div className={styles.aboutme}>
             <div className={styles.text}>
                Full-Stack Developer with 1-year experience creating SPA using MERN
                Stack. I have a strong foundation in front-end and back-end web development.
                I have experience building user-facing web applications using React and Redux, as well as developing server-side logic and
